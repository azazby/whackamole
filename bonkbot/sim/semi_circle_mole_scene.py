...
model_drivers:
    ...
    mole_0: !InverseDynamicsDriver
        gains: 
            mole_slider: {{kp: 100, kd: 10}}
    mole_1: !InverseDynamicsDriver
        gains: 
            mole_slider: {{kp: 100, kd: 10}}
    mole_2: !InverseDynamicsDriver
        gains: 
            mole_slider: {{kp: 100, kd: 10}}
    mole_3: !InverseDynamicsDriver
        gains: 
            mole_slider: {{kp: 100, kd: 10}}
    mole_4: !InverseDynamicsDriver
        gains: 
            mole_slider: {{kp: 100, kd: 10}}
    """
